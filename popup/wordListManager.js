...
function addGroup() {
    ...
    if (document.getElementById("storageLocal").checked) {
        ...
        document.getElementById("createGroupLink").click();
    }
}
function createGroup() {
    ...
    drawColorSelector("groupColorSelector", "#C92E8B","color");
    drawColorSelector("groupFColorSelector", "#FFFFFF", "fcolor");
    if(Settings?.license?.type!=='Free'){
        drawColorSelector("groupBoxSelector", "#C92E8B", "boxcolor");
    }
    else {
    ...
    document.getElementById("example").style.backgroundColor = "#C92E8B";
    document.getElementById("example").style.color = "#FFFFFF";
